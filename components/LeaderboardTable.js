...
import { ChevronDown, Share2, Search,SlidersVertical, AlertCircle } from "lucide-react"
        ...
        {!connected && (
          <div className="flex items-center justify-between p-4 bg-[#25223D] rounded-lg border border-[#464558]">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-white">Connect your wallet to access all features</span>
            </div>
          </div>
        )}
        {/* ... other alerts ... */}
      ...
      {showConnectWalletModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-[#25223D] p-6 rounded-lg max-w-sm w-full mx-4">
            ...
            <p className="text-[#6B7280] mb-6">Please connect your wallet to access this feature.</p>
            ...
            <tbody>
              {sortedTraders.map((trader) => (
                <tr key={trader.id} className="border-b border-[#1E1B2C] bg-[#23242C] hover:bg-[#1E1B2C]/50 cursor-pointer" onClick={() => handleTraderClick(trader.id)}>
                  ...
                  <td className="py-4 px-4 text-end text-white">{trader.tokens}</td>
                  <td className="py-4 px-4 text-end">
                  ...
                  <td className="py-4 px-4 text-end text-white">${trader.avgEntry}</td>
                  <td className="py-4 px-4 text-end text-white">{trader.avgHold}</td>
                  <td className="py-4 px-4 text-end">
